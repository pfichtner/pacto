...
public class TestInputDataProvider implements ArgumentsProvider {
	...
	public static record TestInputData<T>(T in, Function<T, PactoMatcher<T>> creator, BiConsumer<TestTarget, T> consumer,
			String toStringFormat, TriFunction<PactDslJsonBody, String, T, PactDslJsonBody> operator) {
	...
	public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
		...
		return Stream.of( //
				new TestInputData<>(nullVal, o -> new NullValueArg(), (o, v) -> o.stringArg(nullValue()), "nullValue",
						(o, a, v) -> o.nullValue(a)), //
				new TestInputData<>(string, o -> new StringTypeArg(o), (o, v) -> o.stringArg(stringType(v)), "stringType(%s)",
						(o, a, v) -> o.stringType(a, v)), //
				new TestInputData<>(string, o -> new IncludeStrArg(o), (o, v) -> o.stringArg(includeStr(v)), "includeStr(%s)",
						(o, a, v) -> o.includesStr(a, v)), //
				new TestInputData<>(hex, o -> new HexValueArg(o), (o, v) -> o.stringArg(hex(v)), "hex(%s)",
						(o, a, v) -> o.hexValue(a, v)), //
				new TestInputData<>(number, o -> new NumberTypeArg(o), (o, v) -> o.numberArg(numberType(v)), "numberType(%s)",
						(o, a, v) -> o.numberType(a, v)), //
				new TestInputData<>(longVal, o -> new IdArg(o), (o, v) -> o.numberArg(id(v)), "id(%s)",
						(o, a, v) -> o.id(a, v)), //
				new TestInputData<>(uuid, o -> new UuidArg(o), (o, v) -> o.uuidArg(uuid(v.toString())), "uuid(%s)",
						(o, a, v) -> o.uuid(a, v)), //
